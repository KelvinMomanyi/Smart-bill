...
export async function eraseShopData(shop: string) {
  ...
  await prisma.$transaction([
    ...
    prisma.notificationLog.deleteMany({ where: { shop } }),
    prisma.notificationPreference.deleteMany({ where: { shop } }),
    prisma.reportingSnapshot.deleteMany({ where: { shop } }),
    prisma.exchangeRate.deleteMany({ where: { shop } }),
    prisma.creditNote.deleteMany({ where: { shop } }),
    ...
    prisma.approvalRule.deleteMany({ where: { shop } }),

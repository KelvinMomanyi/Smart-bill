...
| Image OCR                        | Pass locally / production credentials required | The real Tesseract runtime read a generated PNG invoice and the parser recovered invoice `SMOKE-1001` with total USD 58.00. Vercel now selects Google Cloud Vision and requires `GOOGLE_APPLICATION_CREDENTIALS_JSON`.                                                                                                                                                                                                       |
